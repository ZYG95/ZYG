...
public class Code {
    ...
    public int stringcount(String s1,String s2){
        int n;
    ...
    public String deletestring(String s1,String s2){
        String s3;
        int n;
        n=CharSetUtils.count(s1,s2);
        if(n==0){
